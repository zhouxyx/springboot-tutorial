            ...
            <div class="cnt_b">
                <div class="form-group">
                     <div class="input-group">
                        ...
                        <input class="form-control input-sm" type="text" id="username" name="username" value="Admin" placeholder="请输入用户名"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control input-sm" type="password" id="password" name="password" value="@12345678"  autocomplete="off" placeholder="请输入密码"/>
                    </div>
                </div>
